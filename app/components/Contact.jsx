...
const [result, setResult] = useState("");
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-size-[90%_auto]'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 w-full' name='message'></textarea>
